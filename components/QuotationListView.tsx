...
const QuotationListView: React.FC<QuotationListViewProps> = ({ 
    ...
    return (
        <div className="flex h-screen w-full flex-col dark:bg-gray-950 p-4 overflow-hidden">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200">
                                <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 focus:bg-gray-100 dark:focus:bg-gray-700" onClick={() => toast.success('Exported quotations to CSV')}>
                                    Export to CSV
                                </DropdownMenuItem>
                                <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 focus:bg-gray-100 dark:focus:bg-gray-700" onClick={() => toast.success('Exported quotations to Excel')}>
                                    Export to Excel
                                </DropdownMenuItem>
                                <DropdownMenuItem className="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 focus:bg-gray-100 dark:focus:bg-gray-700" onClick={() => toast.info('Printing quotation summary...')}>
                                    Print Selected
                                </DropdownMenuItem>
